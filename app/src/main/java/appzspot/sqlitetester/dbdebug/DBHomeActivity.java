package appzspot.sqlitetester.dbdebug;
...
import appzspot.sqlitetester.R;
...
public class DBHomeActivity extends AppCompatActivity {
    ...
    private static class GetTableSchema extends AsyncTaskLoader<String>{
        ...
        public String loadInBackground() {
            ...
            Cursor c = EzQuery.getQuery (getContext ()).rawSql ("PRAGMA table_info(["+tableName+"])");
    ...
    private static class GetAllTables extends AsyncTaskLoader<ArrayList<String>>{
        ...
        public ArrayList<String> loadInBackground() {
            ...
            Cursor c = EzQuery.getQuery (getContext ()).rawSql ("SELECT name FROM sqlite_master WHERE type='table'");
